...
exports.updatePartner = function (req, res, next) {
  ...
  pool.connect(function (err, client, done) {
    ...
    function checkPartnerExistsById(callback) {
      Cms.checkPartnerExistsById(req.params.id, function(err, results) {
        if (err) {
          callback(err);
    ...
    function updatePartner(callback) {
      Cms.updatePartner(client, req.body, function(err, results) {
        if (err) {
          callback(err);
        } else {
