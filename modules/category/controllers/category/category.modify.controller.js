...
exports.updateCategory = function (req, res, next) {
  ...
  pool.connect(function (err, client, done) {
    ...
    function checkCategoryExistsById(callback) {
      Category.checkCategoryExistsById(req.params.id, function(err, results) {
        if (err) {
          callback(err);
    ...
    function updateCategory(callback) {
      Category.updateCategory(client, req.body, function(err, results) {
        if (err) {
          callback(err);
        } else {
