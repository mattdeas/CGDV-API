 ...
 * updateVisual
 */
exports.updateVisual = function (req, res, next) {  
  ...
  pool.connect(function (err, client, done) {
    ...
    function updateVisual(callback) {
      Visual.updateVisual(client, req.body, function(err, results) {
        if (err) {
          callback(err);
        } else {
...
exports.setFeatured = function (req, res, next) {    
  Visual.setFeatured(null, req.body, function (err, results) {
    if (err) {
      next(err);
    } else {    
